...
public class TabInformAdapter extends BaseListAdapter {

    private Context context;

    public TabInformAdapter(Context context){
    ...
    protected void initItemView(BaseViewHolder holder, int position) {
        ...
        text_sign.setText(Values.TAB_INFORM_ITEM_SIGN[position]);
        text_title.setText(Values.TAB_INFORM_ITEM_TITLE[position]);
    }
